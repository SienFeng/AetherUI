...
func MigrateFromV2UI(dbPath string) error {
	...
	if err != nil {
		return common.NewError("init a-ui database failed:", err)
	}
	...
	if err != nil {
		return common.NewError("get a-ui user failed:", err)
	}
	...
	if err != nil {
		return common.NewError("add a-ui inbounds failed:", err)
	}
